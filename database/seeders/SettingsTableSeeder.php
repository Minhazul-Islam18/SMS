...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'MINHAZUL\'s Academy'],
            ['type' => 'system_name', 'description' => 'MINHAZUL\'s Academy of Arabic'],
            ['type' => 'term_ends', 'description' => '08/23/25'],
            ['type' => 'term_begins', 'description' => '08/23/2022'],
            ['type' => 'phone', 'description' => '01630968359'],
            ['type' => 'address', 'description' => 'Begumgonj, Noakhali, Bangladesh'],
            ['type' => 'system_email', 'description' => 'minhaz019166@gmail.com@gmail.com'],
