    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#new-class-type" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i>
                        Class Type</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="new-class-type">
                    <div class="row">
                                                ...
                                                <div class="list-icons">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-left">
                                                            @if (Qs::userIsTeamSA())
                                                                {{-- Edit --}}
                                                                <a href="{{ route('class_type.edit', $c->id) }}"
                                                            ...
                                                            @if (Qs::userIsSuperAdmin())
                                                                {{-- Delete --}}
                                                                <a id="{{ $c->id }}"
                                                                    onclick="ClassTypeconfirmDelete(this.id)" href="#"
                                                                    class="dropdown-item"><i class="icon-trash"></i>
                                                                    Delete</a>
                                                                <form method="post" id="item-delete-{{ $c->id }}"
                                                                    action="{{ route('class_type.destroy', $c->id) }}"
                                                                    class="hidden">
                                                                    @csrf @method('delete')</form>
                                                            @endif
                        ...
                        <div class="col-md-6 col-sm-12 d-flex flex-column align-items-center">
                            <div class="alert alert-success mb-3 w-100 d-block" role="alert">
                                <strong>Create Class Type</strong>
                            </div>

                            <form class="ajax-store-ctype" method="post" action="{{ route('class_type.store') }}">
                                @csrf
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label for="code"
                                        class="col-lg-3 col-form-label font-weight-semibold">Code</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="text-right">
                                    <button id="ajax-btn-ctype" type="submit" class="btn btn-primary">Submit form <i
                                            class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                        </div>
